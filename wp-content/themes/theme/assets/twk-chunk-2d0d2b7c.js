(window.tawkJsonp = window.tawkJsonp || []).push([["chunk-2d0d2b7c"], {
    "5a60": function (t, e, n) {
        "use strict";
        var r = n("2b0e"), o = n("f0b0");
        ...
        var s = r.a.component("i-frame", {
            props: {
                ...
                renderChildren: function () {
                    var t = this.$slots.default, e = this.$el.contentDocument.documentElement,
                        n = this.$el.contentDocument.body, o = this.$el.contentDocument.head,
                        a = document.createElement("div"), i = document.createElement("link"),
                        s = document.createElement("link"), l = new r.a({
                            name: "iApp", data: {children: Object.freeze(t)}, render: function (t) {
                                return t("div", {attrs: {style: "width: 100%; height: 100%;"}}, this.children)
                            }, store: this.$store, mounted: function () {
                    ...
                    i.href = this.cssLink, i.rel = "stylesheet", s.href = "https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i&subset=latin-ext", n.appendChild(a), n.classList.add("font-lato"), this.$store.getters["widget/isRTL"] && n.classList.add("tawk-rtl"), this.$store.getters["browserData/mobileBrowserName"] && (e.classList.add("tawk-mobile"), n.classList.add("tawk-mobile"));
                    var c = document.createElement("meta");
                    c["http-equiv"] = "Content-Type", c.content = "text/html; charset=utf-8";
                    var d = document.createElement("meta");
                    d.name = "viewport", d.content = "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no", o.appendChild(c), o.appendChild(d);
